...
async def draw_image(scores_total,player_total):
    ...
    background_image.save(f'{Path(__file__).parent}/static/final_image.png')
    with open(f'{Path(__file__).parent}/static/final_image.png', "rb") as image_file:
